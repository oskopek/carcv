...
. [line-through]*Install git* *Install GitHub for Windows* - Download it at http://windows.github.com/[]
...
.. For specific instructions, see: link:webapp/howto-jboss-standalone-xml.adoc[Deploy to Openshift]
