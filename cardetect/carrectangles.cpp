                ...
                if( !image.empty() )
                {
                    /*
                                            ...
                                            if( c == 27 || c == 'q' || c == 'Q' )
                                                break;
                     */
                    detectAndSort(image, cascade, nestedCascade, scale, tryflip);
                }
                else
                {
                    ...
                    double scale, bool tryflip )
{
    ...
    CvSeq rectangles;
    cascade.detectMultiScalge( smallImg, objects, fakeLevels, fakeWeights, scaleFactor, minNeighbors, flags, minObjectSize, maxObjectSize, outputRejectLevels);
    rectangles = cvHaarDetectObjectsForROC( smallImg, objects, CvMemStorage* storage, fakeLevels, fakeWeights, scaleFactor, minNeighbors, flags, minObjectSize, maxObjectSize, outputRejectLevels);
