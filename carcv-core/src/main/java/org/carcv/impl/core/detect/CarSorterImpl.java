 ...
 * href="http://en.wikipedia.org/wiki/Levenshtein_distance#Iterative_with_two_matrix_rows">Levenshtein Distance</a>
 ...
 */
public final class CarSorterImpl extends CarSorter {

    private static final Logger LOGGER = LoggerFactory.getLogger(CarSorterImpl.class);

    private static final CarSorterImpl instance = new CarSorterImpl();

    private static final int equalityDistanceCoef = 3;
