    ...
    <body>
        ...
        <div class="mainColumn">
            ...
            <ul>
                ...
                <li> by implementing <a href="https://github.com/oskopek/carcv/blob/master/docs/goals.adoc">planned
                    features</a>
                <li> by translating to a new language
                <li> by <a href="https://github.com/oskopek/carcv/blob/master/docs/howto-write-documentation.adoc">writing
                    or
            ...
            <p>We use the <a href="https://github.com/oskopek/carcv/issues">GitHub issue tracker</a> to track bugs and
                features.
                Before
            ...
            <ul>
                ...
                <li> Run <samp>mvn clean install -Pit</samp>
                    <ul>
                        <li> If you contributed to <strong>carcv-webapp</strong>, run: <samp>mvn clean install
                            -Pit,wildfly-it</samp>
                    </ul>
